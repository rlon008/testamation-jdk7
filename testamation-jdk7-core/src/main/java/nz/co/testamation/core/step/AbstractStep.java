...
package nz.co.testamation.core.step;
...
public abstract class AbstractStep<T> implements Step<T> {
    ...
    public <R> OnGoingExpectationStart<R> when( OnGoingExpectationBuilder<R> onGoingExpectationBuilder ) {
        return onGoingExpectationBuilder.createExpectation();
    }

    public <R> R waitFor( Task<R> task, Predicate<R> predicate ) {
