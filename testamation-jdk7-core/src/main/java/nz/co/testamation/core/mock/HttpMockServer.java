...
public interface HttpMockServer extends OnGoingExpectationBuilder<HttpServletRequestWrapper> {
    void expect( RequestMatcher<HttpServletRequestWrapper> requestMatcher, MockResponse response );
